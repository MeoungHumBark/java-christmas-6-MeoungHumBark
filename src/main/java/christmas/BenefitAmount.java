...
public class BenefitAmount {
    ...
    public static int calculateTotalBenefits(int christmasDiscounts, int weekDiscounts, int specialDiscounts) {
        int totalBenefits = 0;
        totalBenefits += (christmasDiscounts + weekDiscounts + specialDiscounts);
